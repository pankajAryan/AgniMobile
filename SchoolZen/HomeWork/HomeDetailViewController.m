...
- (IBAction)Click_send:(id)sender {
    ...
    [obj_web addHomework:[obj_glob.dictUserInfo valueForKey:@"schoolId"]  staffId:[obj_glob.dictUserInfo valueForKey:@"userId"]  title:txttitle.text message:txtHomeWork.text classId:_strclassId attachmentURL:self.attachementUrl sectionId:_strsectionId subjectId:_strsubjectId];
    }
}
