...
@interface TeacherFeedbackViewController ()

@end

@implementation TeacherFeedbackViewController
...
- (IBAction)Click_Proceed:(id)sender {
    ...
    if (btn_Class.titleLabel.text.length==0 || [btn_Class.titleLabel.text isEqualToString:@"Class"]) {
        ...
        [alert show];
             ...
             || ([btn_Section.titleLabel.text isEqualToString:@"Section"]))
    {
    ...
    SendFeedbackViewController *obj_SendFeedbackViewController=[SendFeedbackViewController new];
